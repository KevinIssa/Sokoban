...
void load_game(tup &pos_player, tup &size_level, string level_s, vector <tup> &goals_v, tup &original_pos)
{
    goals_v.clear();
...
bool listen_key(tup &pos_player, char ch, tup &current_pos, int &push_dir, int niveau, string &level_s, vector<string> data_level, tup original_pos)
{
    bool test = false;
...
void play_move(tup &current_pos, tup &pos_player, int push_dir, string& level_s)
{
...
{   
    ...
    load_game(pos_player, size_level, level_s, goals_v, original_pos);
    ...
    {   
        ...
        int push_dir;
        bool test = listen_key(pos_player, ch, current_pos, push_dir, niveau, level_s, data_level, original_pos);
        if (check_move(test, level_s, current_pos, push_dir))
            play_move(current_pos, pos_player, push_dir, level_s);
